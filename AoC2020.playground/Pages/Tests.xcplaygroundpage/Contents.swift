...
class Day16Tests: XCTestCase {
    ...
    var day16TestData: [String]!
    var ticketHandler: TicketHandler!

    override func setUp() {

        day16TestData = InputFileReader.readInput("Day16Test", stringSeparator: "\n\n")
        ticketHandler = TicketHandler(day16TestData)
    }

    func testDay16() {
        XCTAssertEqual(ticketHandler.ticketScanningErrorRate, 71, "Day 16: Test 1 - Failed.")
        day16TestData = InputFileReader.readInput("Day16Test2", stringSeparator: "\n\n")
        ticketHandler = TicketHandler(day16TestData)
        XCTAssertEqual(ticketHandler.departureProduct, 1, "Day 16: Test 2 - Failed.")
    }
}
...
class Day6Tests: XCTestCase {
    ...
    override func setUp() {
        ...
        day6TestData = InputFileReader.readInput("Day6Test", stringSeparator: "\n\n")
...
class Day4Tests: XCTestCase {
    ...
    override func setUp() {
        day4TestData = InputFileReader.readInput("Day4Test", stringSeparator: "\n\n")
